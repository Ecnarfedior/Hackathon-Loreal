...
sender_email = st.text_input("Adresse e-mail de l'expéditeur:", value="stanlesieur77@gmail.com")
sender_password = st.text_input("Mot de passe de l'expéditeur:", type="password", value="fgyk ttmn nadb idqc")
